...
const features = [
  ...
  "AI-powered RAG pipeline processing",
  "Multi-agent parallel analysis",
  "Traceable knowledge graph output",
];
...
export function DeveloperExperience() {
  ...
  const fullText = `$ baws analyze --document requirements.pdf

✓ Document parsed (12 pages, 3,847 words)
✓ RAG pipeline complete
✓ 5 agents activated in parallel
...
✔ Analysis ready ▸`;
  ...
  return (
    <section
      ref={sectionRef}
      id="ai-agents"
      className="border-y border-border/40 bg-card/30 py-24 sm:py-24"
    >
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          <div>
            ...
            <h2 className="mt-2 font-mono text-3xl font-bold tracking-tight sm:text-4xl text-balance">
              5 specialized agents analyze your documents
            </h2>
            <p className="mt-4 text-lg text-muted-foreground">
              Upload any BA document and let coordinated AI agents handle
              requirements validation, stakeholder mapping, compliance checks,
          ...
          <div className="relative">
            ...
            >
              ...
              <div
                className="p-4 font-mono text-sm flex-1"
